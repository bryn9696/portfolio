    ...
    <section id='portfolio'>
      ...
      <div className="container portfolio__container">
        ...
        <article className='portfolio__item'>
          ...
          <h3>MakersBnB</h3>
          <div className="portfolio__item-cta">
            <a href="https://github.com/chris-clement/MakersBnB" className='btn' target='_blank'>GitHub</a>
            {/* <a href="https://github.com/bryn9696/portfolio" className='btn btn-primary' target='_blank'>Live Demo</a> */}
          </div>
        </article>
        <article className='portfolio__item'>
        ...
        <article className='portfolio__item'>
          ...
          <div className="portfolio__item-cta">
            <a href="https://github.com/bryn9696/rails-ppt" className='btn' target='_blank'>GitHub</a>
            {/* <a href="https://github.com/bryn9696/portfolio" className='btn btn-primary' target='_blank'>Live Demo</a> */}
          </div>
        </article>
      </div>
